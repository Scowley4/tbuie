...
def topic_request():
    ...
    C, topics = ankura.anchor.recover_topics(Q, anchor_vectors, get_c=True)
    ...
    ###
    # FIXME I think this is supposed to use C.T, check with Emily. I have put
    # in C.T for now
    ###
    classifier = ankura.topic.free_classifier_dream(corpus, attr_name, labeled_docs=train_ids, topics=topics, C=C.T, labels=labels)
